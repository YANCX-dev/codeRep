        ...
        if ($error == UPLOAD_ERR_OK) {
            if ($_FILES["loadImg"]["size"][$key] > $maxSize) {
                ...
                if (in_array($type, $validFileTypes)) {
                    ...
                    $dataCard->insertCard($_POST["district"],$_POST["street"],$_POST["house"],$_POST["house_type"],$_POST["elevator"],$_POST["floor_number"],$_POST["number_flat"],$_POST["flat_price"],$_POST["flat_descr"]);
